...
class RevolutCardTest extends TestCase
{
    /**
     * @var RevolutCard
     */
    ...
    public function testGetMethodCodeReturnsCardCode()
    {
        $reflectionMethod = new \ReflectionMethod($this->method, 'getMethodCode');
        $reflectionMethod->setAccessible(true);

        $this->assertSame(ConfigProvider::CODE, $reflectionMethod->invoke($this->method));
    }
}
